...
singleton Material(polo_tire_gravel_material)
{
   ...
   normalMap[1] = "vehicles/87Golf/Textures/polo1_tire_n.png";
   useAnisotropic[1] = "1";
   //diffuseColor[3] = "1.5 1.5 1.5 1";
   castShadows = "1";
   translucent = "1";
...
singleton Material(polo_rim_material)
{
   ...
   specularMap[1] = "vehicles/87Golf/Textures/polo_rim_s.png";
   normalMap[1] = "vehicles/87Golf/Textures/polo1_rim_n.png";
   useAnisotropic[1] = "1";
   specularPower[0] = "16";
   pixelSpecular[0] = "1";
   specularPower[1] = "16";
